...
//  paidRows: Order[] = [];  // Ödeneen satırları ikinci tabloya aktaracağız
...
//        paidOrder.productName === order.productName && paidOrder.table === order.table && paidOrder.quantity === order.quantity);
...
//    this.calculateSelectedOrdersSumCost();
//    this.calculatePaiddOrdersSumCost();
//  }
...
//    console.log("Paid Orders:", this.paidRows);
...
//    console.log("this.sumSelectedOrdersCost", this.sumSelectedOrdersCost);
//  }
//  // paidOrders fiyatlarının toplamını hesaplayan fonksiyon
//  calculatePaiddOrdersSumCost(): void {
//    this.sumPaidOrdersCost = this.paidRows.reduce((total, order) => {
//      return total + (order.cost * order.quantity);  // Fiyat ve miktarı çarparak toplamı alıyoruz
//    }, 0);

//    console.log("this.sumPaidOrdersCost", this.sumPaidOrdersCost);
//  }
//  // paidOrders fiyatlarının toplamını hesaplayan fonksiyon
...
//  }
//  printOrdersClick(): void {


//    console.log("yazdır");
//  }
//  payAllOrdersClick(): void {


//    console.log("tüm hesabı öde");
//  }
//}
import { MatDialog } from '@angular/material/dialog';
import { MatGridListModule } from '@angular/material/grid-list';
